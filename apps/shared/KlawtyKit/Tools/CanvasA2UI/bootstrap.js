...
import "@a2ui/lit/ui";
import { themeContext } from "@klawty/a2ui-theme-context";
...
class KlawtyA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--klawty-a2ui-inset-top, 0px)
        var(--klawty-a2ui-inset-right, 0px)
        var(--klawty-a2ui-inset-bottom, 0px)
        var(--klawty-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--klawty-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--klawty-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--klawty-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--klawty-a2ui-empty-top, var(--klawty-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.klawtyA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["klawty:a2ui-action-status"]) {
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__klawtyLastA2UIAction = userAction;

    const handler =
      globalThis.webkit?.messageHandlers?.klawtyCanvasA2UIAction ??
      globalThis.klawtyCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        // WebKit message handlers support structured objects; Android's JS interface expects strings.
        if (handler === globalThis.klawtyCanvasA2UIAction) {
...
if (!customElements.get("klawty-a2ui-host")) {
  customElements.define("klawty-a2ui-host", KlawtyA2UIHost);
}
