...
public enum KlawtyTalkCommand: String, Codable, Sendable {
...
public struct KlawtyTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct KlawtyTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
