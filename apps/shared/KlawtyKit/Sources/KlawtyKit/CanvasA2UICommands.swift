...
public enum KlawtyCanvasA2UICommand: String, Codable, Sendable {
...
public struct KlawtyCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct KlawtyCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
