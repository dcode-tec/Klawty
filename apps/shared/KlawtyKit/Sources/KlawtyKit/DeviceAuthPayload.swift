...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: KlawtyProtocol.AnyCodable]?
    {
        ...
        return [
            "id": KlawtyProtocol.AnyCodable(identity.deviceId),
            "publicKey": KlawtyProtocol.AnyCodable(publicKey),
            "signature": KlawtyProtocol.AnyCodable(signature),
            "signedAt": KlawtyProtocol.AnyCodable(signedAtMs),
            "nonce": KlawtyProtocol.AnyCodable(nonce),
        ]
    }
}
