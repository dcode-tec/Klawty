...
public struct KlawtyChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct KlawtyChatSessionsDefaults: Codable, Sendable {
...
public struct KlawtyChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct KlawtyChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: KlawtyChatSessionsDefaults?
    public let sessions: [KlawtyChatSessionEntry]
    ...
    public init(
        ...
        sessions: [KlawtyChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
