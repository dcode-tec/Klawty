...
public typealias KlawtyPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias KlawtyPlatformImage = UIImage
#endif

public struct KlawtyChatUsageCost: Codable, Hashable, Sendable {
...
public struct KlawtyChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: KlawtyChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(KlawtyChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct KlawtyChatMessageContent: Codable, Hashable, Sendable {
...
public struct KlawtyChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [KlawtyChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: KlawtyChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [KlawtyChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: KlawtyChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(KlawtyChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([KlawtyChatMessageContent].self, forKey: .content) {
...
public struct KlawtyChatHistoryPayload: Codable, Sendable {
...
public struct KlawtySessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct KlawtySessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [KlawtySessionPreviewItem]
}

public struct KlawtySessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [KlawtySessionPreviewEntry]

    public init(ts: Int, previews: [KlawtySessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct KlawtyChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct KlawtyChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct KlawtyAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct KlawtyChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct KlawtyGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct KlawtyPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: KlawtyPlatformImage?
...
public struct KlawtyChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
