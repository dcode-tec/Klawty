...
enum UIStrings {
    static let welcomeTitle = "Welcome to Klawty"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "klawty.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: KlawtyChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g klawty@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: KlawtyChatViewModel(
