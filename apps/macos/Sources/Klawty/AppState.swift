...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = KlawtyConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = KlawtyConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: KlawtyConfigFile.loadDict(),
        ...
        KlawtyConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/klawty"
        state.remoteCliPath = ""
        return state
    }
}
