...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/klawty/klawty") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/klawty/klawty")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://klawty.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "KlawtyBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KlawtyBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "KlawtyGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KlawtyGitCommit") as? String) ??
            "unknown"
    }
