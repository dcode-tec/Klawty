...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.klawty", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Klawty windows, but below the system’s pop-up menus.
