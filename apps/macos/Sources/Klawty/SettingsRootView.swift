...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .klawtySelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? KlawtyPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? KlawtyPaths.stateDirURL.path
...
extension Notification.Name {
    static let klawtySelectSettingsTab = Notification.Name("klawtySelectSettingsTab")
}
