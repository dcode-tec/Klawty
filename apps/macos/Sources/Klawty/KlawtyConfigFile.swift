...
enum KlawtyConfigFile {
    private static let logger = Logger(subsystem: "ai.klawty", category: "config")
    ...
    static func stateDirURL() -> URL {
        KlawtyPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        KlawtyPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-klawty-config-file",
            "event": "config.write",
