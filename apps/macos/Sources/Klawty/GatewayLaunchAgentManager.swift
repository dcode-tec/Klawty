...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.klawty", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".klawty/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.klawtyCommand(
            subcommand: "gateway",
