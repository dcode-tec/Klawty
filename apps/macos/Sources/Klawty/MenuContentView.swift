...
/// Menu contents for the Klawty menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Klawty") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Klawty Not Configured"
        case .remote:
            "Remote Klawty Active"
        case .local:
            "Klawty Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .klawtySelectSettingsTab, object: tab)
        }
    }
