...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.klawty", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Klawty/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__klawty__/a2ui/").absoluteString + "?platform=macos"
    }
