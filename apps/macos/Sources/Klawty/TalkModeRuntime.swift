...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.klawty", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.klawty", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [KlawtyChatMessage] = messages.compactMap { item in
