...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.klawty.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Klawty", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Klawty gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Klawty.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "KlawtyShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Klawty is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Klawty Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("klawty-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
