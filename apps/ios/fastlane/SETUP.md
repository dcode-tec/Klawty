...
ASC_KEYCHAIN_SERVICE=klawty-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.klawty.client
# or
...
- The beta flow regenerates `apps/ios/Klawty.xcodeproj` from `apps/ios/project.yml` before archiving
