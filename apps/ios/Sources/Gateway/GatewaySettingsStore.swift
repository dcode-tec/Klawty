...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.klawty.gateway"
    private static let nodeService = "ai.klawty.node"
    private static let talkService = "ai.klawty.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.klawty.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.klawty.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("klawty-gateway.log")
    }
