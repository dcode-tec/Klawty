...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.klawty.ios", category: "LiveActivity")
    private var currentActivity: Activity<KlawtyActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = KlawtyActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<KlawtyActivityAttributes>.activities
    ...
    private func updateCurrent(state: KlawtyActivityAttributes.ContentState) {
    ...
    private func connectingState() -> KlawtyActivityAttributes.ContentState {
        KlawtyActivityAttributes.ContentState(
    ...
    private func idleState() -> KlawtyActivityAttributes.ContentState {
        KlawtyActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> KlawtyActivityAttributes.ContentState {
        KlawtyActivityAttributes.ContentState(
