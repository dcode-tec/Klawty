...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: KlawtyPhotosLatestParams) async throws -> KlawtyPhotosLatestPayload {
        ...
        var results: [KlawtyPhotoPayload] = []
        ...
        return KlawtyPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> KlawtyPhotoPayload
    {
