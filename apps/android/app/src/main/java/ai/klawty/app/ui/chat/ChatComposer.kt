...
import ai.klawty.app.ui.mobileAccentBorderStrong
...
import ai.klawty.app.ui.mobileSurface
import ai.klawty.app.ui.mobileText
import ai.klawty.app.ui.mobileTextSecondary
import ai.klawty.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.klawty.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.klawty.app.ui.mobileFontFamily,
