    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Klawty Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("klawty qr --setup-code-only")
          CommandBlock("klawty qr --json")
