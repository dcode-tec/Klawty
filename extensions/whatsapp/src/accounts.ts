...
export function listWhatsAppAuthDirs(cfg: KlawtyConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: KlawtyConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: KlawtyConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: KlawtyConfig): ResolvedWhatsAppAccount[] {
