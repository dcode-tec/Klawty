...
import { SafeOpenError, readLocalFileSafely } from "klawty/plugin-sdk/infra-runtime";
import type { SsrFPolicy } from "klawty/plugin-sdk/infra-runtime";
import { type MediaKind, maxBytesForKind } from "klawty/plugin-sdk/media-runtime";
import { fetchRemoteMedia } from "klawty/plugin-sdk/media-runtime";
import {
  convertHeicToJpeg,
  hasAlphaChannel,
  optimizeImageToPng,
...
import { getDefaultMediaLocalRoots } from "klawty/plugin-sdk/media-runtime";
import { detectMime, extensionForMime, kindFromMime } from "klawty/plugin-sdk/media-runtime";
import { logVerbose, shouldLogVerbose } from "klawty/plugin-sdk/runtime-env";
import { resolveUserPath } from "klawty/plugin-sdk/text-runtime";
...
async function assertLocalMediaAllowed(
  ...
  // Hardening: the default allowlist includes the Klawty temp dir, and tests/CI may
