...
import type { SignalAccountConfig } from "klawty/plugin-sdk/signal-core";
...
function mergeSignalAccountConfig(cfg: KlawtyConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: KlawtyConfig): ResolvedSignalAccount[] {
