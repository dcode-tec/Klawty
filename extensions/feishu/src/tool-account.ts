...
import type { KlawtyPluginApi } from "../runtime-api.js";
...
function readConfiguredDefaultAccountId(config: KlawtyPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<KlawtyPluginApi, "config">;
