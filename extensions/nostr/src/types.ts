...
} from "klawty/plugin-sdk/account-id";
...
function resolveConfiguredDefaultNostrAccountId(cfg: KlawtyConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: KlawtyConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: KlawtyConfig): string {
