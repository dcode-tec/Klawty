...
Nostr DM channel plugin for Klawty using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Klawty. It enables your bot to:
...
# Configure klawty to use local relay
