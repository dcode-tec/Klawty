...
import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "klawty/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "klawty/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("klawty/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("klawty/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("klawty/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("klawty/plugin-sdk/channel-runtime").resolveConversationLabel;
type RecordInboundSessionMetaSafe =
  typeof import("klawty/plugin-sdk/channel-runtime").recordInboundSessionMetaSafe;
type ResolveMarkdownTableMode =
  typeof import("klawty/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("klawty/plugin-sdk/routing").resolveAgentRoute;
