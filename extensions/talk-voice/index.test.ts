...
import type { KlawtyPluginCommandDefinition } from "../../test/helpers/extensions/plugin-command.js";
import { createPluginRuntimeMock } from "../../test/helpers/extensions/plugin-runtime-mock.js";
import register from "./index.js";

function createHarness(config: Record<string, unknown>) {
  let command: KlawtyPluginCommandDefinition | undefined;
  ...
  const api = {
    runtime,
    registerCommand: vi.fn((definition: KlawtyPluginCommandDefinition) => {
      command = definition;
    }),
  };
