...
export async function resolveTlonSetupConfigured(cfg: KlawtyConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: KlawtyConfig): Promise<string[]> {
