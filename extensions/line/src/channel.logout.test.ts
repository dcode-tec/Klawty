...
import type { KlawtyConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: KlawtyConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: KlawtyConfig; accountId: string }): Promise<{
