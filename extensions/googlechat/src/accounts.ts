...
import { isSecretRef, type KlawtyConfig } from "klawty/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: KlawtyConfig): ResolvedGoogleChatAccount[] {
