...
This directory contains the **BlueBubbles external channel plugin** for Klawty.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `klawty/plugin-sdk` helpers.
