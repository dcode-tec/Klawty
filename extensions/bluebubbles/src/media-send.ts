...
import { resolveChannelMediaMaxBytes, type KlawtyConfig } from "./runtime-api.js";
...
function resolveMediaLocalRoots(params: { cfg: KlawtyConfig; accountId?: string }): string[] {
