...
import type { KlawtyPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "klawty.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): KlawtyPluginConfigSchema {
  return {
