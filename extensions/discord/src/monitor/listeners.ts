...
import { formatDurationSeconds } from "klawty/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("klawty/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("klawty/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("klawty/plugin-sdk/runtime-env").createSubsystemLogger>;
