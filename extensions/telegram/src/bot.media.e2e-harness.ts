...
import type { GetReplyOptions, MsgContext } from "klawty/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("klawty/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as KlawtyConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("klawty/plugin-sdk/media-runtime")>,
) {
...
vi.mock("klawty/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("klawty/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("klawty/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
