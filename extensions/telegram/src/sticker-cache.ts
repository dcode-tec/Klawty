...
import { resolveApiKeyForProvider } from "klawty/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "klawty/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "klawty/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "klawty/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "klawty/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "klawty/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "klawty/plugin-sdk/runtime-env";
import { STATE_DIR } from "klawty/plugin-sdk/state-paths";
