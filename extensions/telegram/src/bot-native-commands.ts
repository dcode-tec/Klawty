...
import { recordInboundSessionMetaSafe } from "klawty/plugin-sdk/channel-runtime";
...
import { resolveCommandAuthorization } from "klawty/plugin-sdk/reply-runtime";
import type { CommandArgs } from "klawty/plugin-sdk/reply-runtime";
import {
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): KlawtyConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: KlawtyConfig): TelegramAccountConfig => {
    try {
