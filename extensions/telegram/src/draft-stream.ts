...
import { createFinalizableDraftLifecycle } from "klawty/plugin-sdk/channel-runtime";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("klawty.telegramDraftStreamState");
