...
function mergeZalouserAccountConfig(cfg: KlawtyConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: KlawtyConfig; accountId?: string | null }) {
