...
import { createDeferred } from "klawty/plugin-sdk/extension-shared";
...
} from "klawty/plugin-sdk/reply-history";
import type {
  MarkdownTableMode,
  KlawtyConfig,
...
function resolveZalouserDmSessionScope(config: KlawtyConfig) {
