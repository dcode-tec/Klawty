...
import type { KlawtyPluginConfigSchema } from "klawty/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): KlawtyPluginConfigSchema {
