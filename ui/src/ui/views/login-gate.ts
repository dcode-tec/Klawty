    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Klawty" />
          <div class="login-gate__title">Klawty</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="KLAWTY_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
