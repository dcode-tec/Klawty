...
- Install via CLI: `klawty plugins install @klawty/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `klawty plugins install ./extensions/zalo`
   - From npm (if published): `klawty plugins install @klawty/zalo`
...
This page reflects current Klawty behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `klawty pairing list zalo`
  - `klawty pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Klawty.
...
- Example: `klawty message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `klawty channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `klawty logs --follow`
