...
read_when:
  ...
  - Reviewing Klawty security posture
title: "Pairing"
---

# Pairing

“Pairing” is Klawty’s explicit **owner approval** step.
...
Stored under `~/.klawty/credentials/`:
...
3. On your phone, open the Klawty iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `klawty nodes pending/approve`) is a
