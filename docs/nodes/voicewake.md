...
Klawty treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.klawty/settings/voicewake.json`

Shape:

```json
{ "triggers": ["klawty", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
