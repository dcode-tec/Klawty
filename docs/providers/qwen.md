---
summary: "Use Qwen OAuth (free tier) in Klawty"
read_when:
  - You want to use Qwen with Klawty
...
If you already logged in with the Qwen Code CLI, Klawty will sync credentials
