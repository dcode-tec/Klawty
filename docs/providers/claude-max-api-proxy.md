...
You can point Klawty at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Klawty
...
- [Anthropic provider](/providers/anthropic) - Native Klawty integration with Claude setup-token or API keys
