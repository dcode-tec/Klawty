---
summary: "Use Qianfan's unified API to access many models in Klawty"
read_when:
...
3. Klawty installed on your system
...
4. Copy the API key for use with Klawty

## CLI setup

```bash
klawty onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Klawty Configuration](/gateway/configuration)
