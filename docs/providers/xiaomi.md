---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Klawty"
read_when:
  - You want Xiaomi MiMo models in Klawty
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Klawty uses
...
```bash
klawty onboard --auth-choice xiaomi-api-key
# or non-interactive
klawty onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
