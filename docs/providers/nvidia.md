---
summary: "Use NVIDIA's OpenAI-compatible API in Klawty"
read_when:
  - You want to use NVIDIA models in Klawty
...
klawty onboard --auth-choice skip
klawty models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
