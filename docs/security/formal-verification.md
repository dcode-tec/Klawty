...
summary: Machine-checked security models for Klawty’s highest-risk paths.
read_when:
...
This page tracks Klawty’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Klawty enforces its
...
**What this is not (yet):** a proof that “Klawty is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/klawty-formal-models](https://github.com/vignesh07/klawty-formal-models).
...
```bash
git clone https://github.com/vignesh07/klawty-formal-models
cd klawty-formal-models
