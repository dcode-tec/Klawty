...
read_when:
  - You want to publish a third-party Klawty plugin
...
This page tracks high-quality **community-maintained plugins** for Klawty.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `klawty plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `klawty plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Klawty to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/klawty-wechat`
  repo: `https://github.com/icesword0760/klawty-wechat`
  install: `klawty plugins install @icesword760/klawty-wechat`
