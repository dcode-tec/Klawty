...
read_when:
  - You want Zalo Personal (unofficial) support in Klawty
...
Zalo Personal support for Klawty via a plugin, using native `zca-js` to automate a normal Zalo user account.
