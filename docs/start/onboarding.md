---
summary: "First-run setup flow for Klawty (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Klawty">
...
<Step title="CLI">
  ...
  The app can install the global `klawty` CLI via npm/pnpm so terminal
