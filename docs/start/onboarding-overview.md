---
summary: "Overview of Klawty onboarding options and flows"
read_when:
...
Klawty supports multiple onboarding paths depending on where the Gateway runs
...
- [`klawty onboard` command](/cli/onboard)

## macOS app onboarding

Use the Klawty app when you want a fully guided setup on macOS. Docs:
