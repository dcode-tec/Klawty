...
本指南总结了在 Klawty 中开发 Pi 集成的合理工作流程。
...
状态存储在 Klawty 状态目录下。默认为 `~/.klawty`。如果设置了 `KLAWTY_STATE_DIR`，则使用该目录。
...
- https://docs.klawty.ai/testing
- https://docs.klawty.ai/start/getting-started
