...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']klawty\/plugin-sdk["']/,
    hint: "Use klawty/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']klawty\/plugin-sdk\/test-utils["']/,
    hint: "Use klawty/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']klawty\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or klawty/plugin-sdk/testing for public surfaces.",
  },
  {
