...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "klawty", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Klawty. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Klawty Issue Label Audit");
