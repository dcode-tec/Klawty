/**
 * Hook system for Klawty agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __klawty_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__klawty_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
