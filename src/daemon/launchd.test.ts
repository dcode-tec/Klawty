...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.klawty.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", KLAWTY_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("restarts LaunchAgent with kickstart and no bootout", async () => {
    ...
    expect(cleanStaleGatewayProcessesSync).toHaveBeenCalledWith(2508);
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.klawty.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when KLAWTY_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.klawty.gateway.plist",
    },
    {
      name: "uses profile-specific label when KLAWTY_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", KLAWTY_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.klawty.jbphoenix.plist",
    },
    {
      name: "prefers KLAWTY_LAUNCHD_LABEL over KLAWTY_PROFILE",
      env: {
        HOME: "/Users/test",
        KLAWTY_PROFILE: "jbphoenix",
        KLAWTY_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from KLAWTY_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        KLAWTY_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty KLAWTY_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        KLAWTY_PROFILE: "myprofile",
        KLAWTY_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.klawty.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
