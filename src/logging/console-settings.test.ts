...
let originalKlawtyTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalKlawtyTestConsole = process.env.KLAWTY_TEST_CONSOLE;
  process.env.KLAWTY_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalKlawtyTestConsole === undefined) {
    delete process.env.KLAWTY_TEST_CONSOLE;
  } else {
    process.env.KLAWTY_TEST_CONSOLE = originalKlawtyTestConsole;
  }
