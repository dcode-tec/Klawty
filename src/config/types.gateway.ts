...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "klawty.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.klawty/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/klawty"). */
  basePath?: string;
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/klawty/klawty/issues/47711
   */
...
export type GatewayConfig = {
  /** Single multiplexed port for Gateway WS + HTTP (default: 2508). */
  port?: number;
  /**
