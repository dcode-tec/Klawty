...
function resolveAnthropicDefaultAuthMode(cfg: KlawtyConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: KlawtyConfig): KlawtyConfig {
...
export function applyTalkApiKey(config: KlawtyConfig): KlawtyConfig {
...
export function applyTalkConfigNormalization(config: KlawtyConfig): KlawtyConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: KlawtyConfig): KlawtyConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: KlawtyConfig): KlawtyConfig {
...
export function applyLoggingDefaults(cfg: KlawtyConfig): KlawtyConfig {
...
export function applyContextPruningDefaults(cfg: KlawtyConfig): KlawtyConfig {
...
export function applyCompactionDefaults(cfg: KlawtyConfig): KlawtyConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
