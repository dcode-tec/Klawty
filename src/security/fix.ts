...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof KlawtyConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: KlawtyConfig; env: NodeJS.ProcessEnv }): {
  cfg: KlawtyConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
