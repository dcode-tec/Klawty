      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["klawty gateway run", "Run the gateway in the foreground."],
            ["klawty gateway status", "Show service status and probe reachability."],
            ["klawty gateway discover", "Find local and wide-area gateway beacons."],
            ["klawty gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.klawty.ai/cli/gateway")}\n`,
      ),
  );
