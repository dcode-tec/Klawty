    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["klawty directory self --channel slack", "Show the connected account identity."],
          [
            'klawty directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["klawty directory groups list --channel discord", "List available groups/channels."],
          [
            "klawty directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.klawty.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
