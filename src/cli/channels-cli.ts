    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["klawty channels list", "List configured channels and auth profiles."],
          ["klawty channels status --probe", "Run channel status checks and probes."],
          [
            "klawty channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["klawty channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.klawty.ai/cli/channels",
        )}\n`,
    );
