...
export function applyProviderDefaultModel(cfg: KlawtyConfig, modelRef: string): KlawtyConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: KlawtyConfig; modelId: string; modelRef: string; profileId: string } {
