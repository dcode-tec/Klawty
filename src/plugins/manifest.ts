...
export const PLUGIN_MANIFEST_FILENAME = "klawty.plugin.json";
...
// package.json "klawty" metadata (used for setup/catalog)
...
export type KlawtyPackageStartup = {
  /**
...
export type KlawtyPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: KlawtyPackageStartup;
};
...
): KlawtyPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
