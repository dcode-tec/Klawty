...
export const A2UI_PATH = "/__klawty__/a2ui";

export const CANVAS_HOST_PATH = "/__klawty__/canvas";

export const CANVAS_WS_PATH = "/__klawty__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.klawtyCanvasA2UIAction.postMessage(...)
  // - Android: window.klawtyCanvasA2UIAction.postMessage(...)
  const handlerNames = ["klawtyCanvasA2UIAction"];
  ...
  globalThis.Klawty = globalThis.Klawty ?? {};
  globalThis.Klawty.postMessage = postToNode;
  globalThis.Klawty.sendUserAction = sendUserAction;
  globalThis.klawtyPostMessage = postToNode;
  globalThis.klawtySendUserAction = sendUserAction;
