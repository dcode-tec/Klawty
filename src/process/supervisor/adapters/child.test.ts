...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.KLAWTY_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.KLAWTY_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.KLAWTY_SERVICE_MARKER = originalServiceMarker;
    }
  });
