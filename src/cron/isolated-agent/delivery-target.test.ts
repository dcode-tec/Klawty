...
function makeCfg(overrides?: Partial<KlawtyConfig>): KlawtyConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): KlawtyConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: KlawtyConfig) {
