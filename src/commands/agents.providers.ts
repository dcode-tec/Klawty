...
function resolveDefaultAccountId(cfg: KlawtyConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: KlawtyConfig): boolean {
...
export function summarizeBindings(cfg: KlawtyConfig, bindings: AgentBinding[]): string[] {
