...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.klawty.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("klawty hooks list")}`,
      `  ${formatCliCommand("klawty hooks enable <name>")}`,
      `  ${formatCliCommand("klawty hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
