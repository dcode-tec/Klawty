...
async function runRuntimeWebTools(params: { config: KlawtyConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: KlawtyConfig, provider: ProviderUnderTest): unknown {
