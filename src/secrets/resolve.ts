...
function resolveResolutionLimits(config: KlawtyConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: KlawtyConfig): SecretProviderConfig {
