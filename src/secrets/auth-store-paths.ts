...
export function listAuthProfileStorePaths(config: KlawtyConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: KlawtyConfig, stateDir: string): string[] {
