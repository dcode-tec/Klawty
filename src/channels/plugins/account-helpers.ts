...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: KlawtyConfig): string | undefined {
  ...
  function listAccountIds(cfg: KlawtyConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: KlawtyConfig): string {
