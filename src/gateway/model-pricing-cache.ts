...
export function collectConfiguredModelPricingRefs(config: KlawtyConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: KlawtyConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
