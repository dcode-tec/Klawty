...
export function hasAmbiguousGatewayAuthModeConfig(cfg: KlawtyConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: KlawtyConfig): void {
