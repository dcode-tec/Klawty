...
describe("gateway auth", () => {
  ...
  it("resolves token/password from KLAWTY gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          KLAWTY_GATEWAY_TOKEN: "env-token",
          KLAWTY_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides KLAWTY_GATEWAY_PASSWORD", () => {
