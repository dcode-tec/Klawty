...
function resolveSpeechProviderPluginEntries(cfg?: KlawtyConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: KlawtyConfig): SpeechProviderPlugin[] {
