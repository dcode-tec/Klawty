...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: KlawtyConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: KlawtyConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: KlawtyConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: KlawtyConfig }): Promise<void> {
