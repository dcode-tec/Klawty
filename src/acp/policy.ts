...
export function isAcpEnabledByPolicy(cfg: KlawtyConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: KlawtyConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: KlawtyConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: KlawtyConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: KlawtyConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: KlawtyConfig, agentId: string): boolean {
