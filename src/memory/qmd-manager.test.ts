...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: KlawtyConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: KlawtyConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__klawtyMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__klawtyMcporterColdStartWarned;
  });
