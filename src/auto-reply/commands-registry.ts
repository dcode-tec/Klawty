...
export function isCommandEnabled(cfg: KlawtyConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: KlawtyConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: KlawtyConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: KlawtyConfig) {
