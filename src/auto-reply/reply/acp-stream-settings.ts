...
function resolveAcpStreamCoalesceIdleMs(cfg: KlawtyConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: KlawtyConfig): number {
...
export function resolveAcpProjectionSettings(cfg: KlawtyConfig): AcpProjectionSettings {
