...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@klawty", { botUsername: "klawty" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@klawty args", {
        botUsername: "klawty",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "klawty" })).toBe(
      "/help@otherbot",
    );
  });
