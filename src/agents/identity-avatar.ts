...
function resolveAvatarSource(cfg: KlawtyConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: KlawtyConfig, agentId: string): AgentAvatarResolution {
