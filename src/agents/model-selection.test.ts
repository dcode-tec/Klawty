...
function resolveAnthropicOpusThinking(cfg: KlawtyConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<KlawtyConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<KlawtyConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<KlawtyConfig> = {
        agents: {
          defaults: {
            models: {
