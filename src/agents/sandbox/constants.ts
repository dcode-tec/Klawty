...
export const DEFAULT_SANDBOX_IMAGE = "klawty-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "klawty-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "klawty-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "klawty-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "klawty-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "klawty-sandbox-browser";
