...
function resolveAdaptiveReadMaxBytes(options?: KlawtyReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createKlawtyReadTool(base, {
...
export function createKlawtyReadTool(
  base: AnyAgentTool,
  options?: KlawtyReadToolOptions,
): AnyAgentTool {
