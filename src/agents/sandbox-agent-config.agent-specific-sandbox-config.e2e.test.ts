...
async function resolveContext(config: KlawtyConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): KlawtyConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
