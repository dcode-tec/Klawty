...
function resolveWatchPaths(workspaceDir: string, config?: KlawtyConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: KlawtyConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: KlawtyConfig }) {
