...
const defaultTools = createKlawtyCodingTools({ senderIsOwner: true });
...
describe("createKlawtyCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: KlawtyConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createKlawtyCodingTools({
    ...
    const anthropicTools = createKlawtyCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: KlawtyConfig = {
      tools: {
        exec: {
    ...
    const allowed = createKlawtyCodingTools({
    ...
    const denied = createKlawtyCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createKlawtyCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
