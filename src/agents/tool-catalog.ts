...
function buildCoreToolGroupMap() {
  ...
  const klawtyTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInKlawtyGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:klawty": klawtyTools,
