...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/klawty-sandbox",
    agentWorkspaceDir: "/tmp/klawty-workspace",
    workspaceAccess: "none",
    runtimeId: "klawty-sbx-test",
    runtimeLabel: "klawty-sbx-test",
    containerName: "klawty-sbx-test",
    ...
    browser: {
      ...
      containerName: "klawty-sbx-browser-test",
    },
