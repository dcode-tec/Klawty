...
export function resolveSubagentToolPolicy(cfg?: KlawtyConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: KlawtyConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: KlawtyConfig["tools"];
