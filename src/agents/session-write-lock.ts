...
const CLEANUP_STATE_KEY = Symbol.for("klawty.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("klawty.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("klawty.sessionWriteLockWatchdogState");
