...
function resolvePostCompactionIndexSyncMode(config?: KlawtyConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureKlawtyModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createKlawtyCodingTools({
      exec: {
